# =========================================================================
# ⚙️ CONFIGURACIÓN GLOBAL DEL BOT (CAMBIAR ESTOS DATOS PARA CADA PROYECTO)
# =========================================================================

# Símbolo que se usará antes de cada comando (ejemplo: /hola, /bailar)
prefix = '/'

# ID único de la sala de Highrise donde ingresará el bot
room = 'PONER_AQUI_EL_ID_DE_LA_SALA'
...
coordinates = {
    'x': 0.0,              # Posición horizontal
    'y': 0.0,              # Altura/Piso
    'z': 0.0,              # Profundidad
    'facing': 'FrontRight' # Dirección a la que mira ('FrontRight', 'FrontLeft', 'BackRight', 'BackLeft')
}
# =========================================================================
